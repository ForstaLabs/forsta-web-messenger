...
MessageSender.prototype = {
    ...
    uploadAttachments: async function(message) {
        ...
        try {
            ...
            if (e instanceof textsecure.ProtocolError) {
    ...
    sendMessageToAddrs: async function(addrs, body, attachments, timestamp, expiration, flags) {
        ...
        return await this.sendMessage({
            ...
            attachments,
            expiration,
            needsSync: true, // XXX used anymore?
            flags
        });
    },
