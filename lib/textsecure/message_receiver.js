...
function MessageReceiver(textSecureServer, signalingKey) {
    ...
    const url = this.server.getMessageWebSocketURL();
...
MessageReceiver.prototype.extend({
    ...
    onSocketClose: async function(ev) {
    ...
    tryMessageAgain: function(from, ciphertext) {
        ...
        return this.decryptPreKeyWhisperMessage(ciphertext, sessionCipher, address).then(function(plaintext) {
            const finalMessage = textsecure.protobuf.DataMessage.decode(plaintext);
...
textsecure.MessageReceiver = function(textSecureServer, signalingKey) {
    const messageReceiver = new MessageReceiver(textSecureServer, signalingKey);
    this.addEventListener = messageReceiver.addEventListener.bind(messageReceiver);
    this.removeEventListener = messageReceiver.removeEventListener.bind(messageReceiver);
    this.getStatus = messageReceiver.getStatus.bind(messageReceiver);
    this.connect = messageReceiver.connect.bind(messageReceiver);
