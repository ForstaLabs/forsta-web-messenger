...
function MessageSender(url, port, username, password, attachment_server_url) {
...
textsecure.MessageSender = function(url, port, username, password, attachment_server_url) {
    var sender = new MessageSender(url, port, username, password, attachment_server_url);
