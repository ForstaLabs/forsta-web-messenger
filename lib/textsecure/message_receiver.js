...
MessageReceiver.prototype.extend({
    ...
    processDecrypted: async function(msg, source) {
        ...
        if (msg.flags & textsecure.protobuf.DataMessage.Flags.END_SESSION) {
            ...
            msg.group = null;
            return msg;
        } else if (msg.flags & textsecure.protobuf.DataMessage.Flags.EXPIRATION_TIMER_UPDATE ) {
            debugger;
            msg.body = null;
            msg.attachments = [];
        } else if (msg.flags != 0) {
        ...
        if (msg.group) {
            ...
            if (!existingAddrs) {
                ...
                if (msg.group.type === textsecure.protobuf.GroupContext.Type.UPDATE) {
                    debugger;
                    msg.body = null; // XXX why?
                    msg.attachments = []; // XXX why?
                ...
                } else if (msg.group.type === textsecure.protobuf.GroupContext.Type.DELIVER) {
                    console.warn("NOT CLearing group data!  Why would we want to do this!?");
                    //msg.group.name = null; // XXX why?
                    //msg.group.members = []; // XXX why?
                    //msg.group.avatar = null; // XXX why?
                } else {
