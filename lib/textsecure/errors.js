...
;(function() {
    ...
    ReplayableError.prototype.replay = function() {
        return registeredFunctions[this.functionCode].apply(self, this.args);
    };
    ...
    self.textsecure.UnregisteredUserError = UnregisteredUserError;
    self.textsecure.SendMessageNetworkError = SendMessageNetworkError;
    self.textsecure.IncomingIdentityKeyError = IncomingIdentityKeyError;
    self.textsecure.OutgoingIdentityKeyError = OutgoingIdentityKeyError;
    self.textsecure.ReplayableError = ReplayableError;
    self.textsecure.OutgoingMessageError = OutgoingMessageError;
    self.textsecure.MessageError = MessageError;
