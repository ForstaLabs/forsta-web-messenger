...
<html class="F O R S T A">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/@static/stylesheets/chat.css?v={{version}}"/>
        ...
        <script defer type="text/javascript" src="/@static/js/app/chat{{minify_ext}}.js?v={{version}}"></script>
    </head>
