...
(function() {
    ...
    ns.TextSecureServer = function(url, port, username, password, addr, deviceId,
                                   attachmentsUrl) {
    ...
    ns.TextSecureServer.prototype = {
        ...
        getMyKeys: function(addr, deviceId) {
            return this.ajax({
                call: 'keys',
        ...
        getKeysForAddr: function(addr, deviceId) {
